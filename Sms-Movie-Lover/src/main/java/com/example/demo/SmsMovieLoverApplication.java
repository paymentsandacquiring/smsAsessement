...
//		controller.getAllMovies();
		...
		controller.addGenre(movieName, movieYear, "Fantasy");
		controller.addCast(movieName, movieYear, "Arya", "Stark", "Maisie");
		controller.addPublisher(movieName, movieYear, "HBO");
